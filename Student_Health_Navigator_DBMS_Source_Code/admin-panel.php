...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> STUDENT HEALTH NAVIGATOR</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> STUDENT HEALTH NAVIGATOR </a>
  ...
  <style >
    body.bg-image {
        background-image: url('https://scontent.fdel27-5.fna.fbcdn.net/v/t1.6435-9/60662742_2259279520814487_3936187507871318016_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=5f2048&_nc_ohc=yi7aXCDUcuMAb56ESV7&_nc_ht=scontent.fdel27-5.fna&oh=00_AfB_lyevl2o5JKrVBnuIbgwlxmGH2aeUepQV8ya-NxIqYA&oe=664ADCF9'); /* Specify the path to your background image */
...
.btn-primary{
  ...
  <body style="padding-top:50px;" class="bg-image" >
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              onClick=""
                              title="Accept Prescription" tooltip-placement="top" tooltip="Remove"><button class="btn btn-success">Accept</button>
                              </a></td> -->

                              <a href="admin-panel.php?ID=<?php echo $row['ID']?>">
                              <input type ="hidden" name="ID" value="<?php echo $row['ID']?>"/>
                              <input type = "submit" onclick="alert('Prescription Accepted Successfully');" name ="generate_bill" class = "btn btn-success" value="Accept Prescription"/>
                              </a>
                              </td>
                              </form>
