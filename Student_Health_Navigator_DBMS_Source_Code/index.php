<html>
<head>
	<title>Student Health Navigator</title>
...
<style>
    ...
    .text-primary {
        color: #007bff; /* Blue color for primary text */
    }
    ...
    .text-info {
        color: #17a2b8; /* Turquoise color for link text */
    }
        .form-control {
            border-radius: 0.75rem;
        }
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp STUDENT HEALTH NAVIGATOR</h4></a>
...
<div class="container register " style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://t4.ftcdn.net/jpg/03/41/47/73/240_F_341477352_FPoRvWnWWqdzVFnIWn3on34gYWaSEX2K.jpg" alt="Welcome_Image" >
